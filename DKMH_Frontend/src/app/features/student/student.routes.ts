...
export const STUDENT_ROUTES: Routes = [
  ...
  { path: 'results', loadComponent: () => import('./student-results/student-results.component').then(c => c.StudentResultsComponent) },
  { path: 'history', loadComponent: () => import('./student-history/student-history.component').then(c => c.StudentHistoryComponent) },
