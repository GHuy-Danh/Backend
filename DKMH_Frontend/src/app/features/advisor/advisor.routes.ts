...
export const ADVISOR_ROUTES: Routes = [
  ...
  // URL: /advisor/reports (Các báo cáo, ví dụ: tình hình đăng ký của sinh viên)
  { path: 'reports', loadComponent: () => import('./advisor-reports/advisor-reports.component').then(c => c.AdvisorReportsComponent) },
